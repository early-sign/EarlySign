...
Examples:
    ...
    >>> from earlysign.controllers.ConfidenceSequence_WaudbySmith2021 import BinomialConfidenceSequenceWaudbySmith2021Controller
...
from earlysign.methods.AVI import GAVIEngine
