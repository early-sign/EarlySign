...
from earlysign.methods.AVI import GAVIEngine, mSPRTEngine
from earlysign.methods.AVI.reporting import FinalProjector, ProgressProjector
...
class AsymptoticConfidenceSequenceMaharaj2023Controller(Controller[Protocol]):
    ...
    Examples:
        ...
        >>> import earlysign.schema.ES3.Base as ES3_BASE
        >>> from earlysign.controllers.AsymptoticConfidenceSequence_Maharaj2023 import AsymptoticConfidenceSequenceMaharaj2023Controller
        >>>
        >>> # Setup ledger
