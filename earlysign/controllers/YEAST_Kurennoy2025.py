...
from earlysign.methods.YEAST.engine import BinomialYEASTEngine, ContinuousYEASTEngine
from earlysign.methods.YEAST.reporting import FinalProjector, ProgressProjector
...
class ContinuousKurennoy2025Controller(Controller[Protocol]):
    ...
    Examples:
        ...
        >>> from earlysign.core.ledger import Ledger
        >>> import earlysign.schema.ES3.Base as ES3_BASE
        >>> from earlysign.controllers.YEAST_Kurennoy2025 import ContinuousKurennoy2025Controller, ContinuousKurennoy2025TaskSpec
        >>> from earlysign.schema.ES3.Continuous import ContinuousArmData
