...
linkml_meta = LinkMLMeta(
    {
        "default_prefix": "https://earlysign.io/schema/ES3/binomial/",
        "default_range": "string",
        "id": "https://earlysign.io/schema/ES3/binomial",
        "imports": ["linkml:types", "./base"],
        "name": "es3_binomial",
        "source_file": "earlysign/schema/ES3/binomial.yaml",
        "title": "EarlySign Binomial Core Schema",
    }
)
...
class ArmMetrics(Log):
    ...
    total: int = Field(
        default=...,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ArmMetrics", "BinomialArmData"]}
        },
    )
    ...
    successes: Optional[int] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ArmMetrics", "BinomialArmMetrics"]}
        },
    )
...
class BinomialArmMetrics(ArmMetrics):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://earlysign.io/schema/ES3/binomial"}
    )
...
class ExactBinomialModel(Log):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://earlysign.io/schema/ES3/binomial"}
    )

    kind: Literal["exact_binomial"] = Field(
...
class BinomialArmData(Log):
    ...
    arm: str = Field(
        default=...,
        json_schema_extra={"linkml_meta": {"domain_of": ["BinomialArmData"]}},
    )
    total: int = Field(
        default=...,
        json_schema_extra={
...
BinomialArmMetrics.model_rebuild()
ExactBinomialModel.model_rebuild()
BinomialArmData.model_rebuild()
