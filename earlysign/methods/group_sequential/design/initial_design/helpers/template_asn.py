...
the :class:`~earlysign.methods.group_sequential.asn.ASNCalculator`
...
Examples
--------
>>> from earlysign.methods.group_sequential.design.initial_design.helpers.template_asn import TemplateASNAdapter
