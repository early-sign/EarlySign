...
from earlysign.methods.group_sequential.design.initial_design.constants import (
    SpendingFamily,
)
...
from earlysign.stats.schemes.two_means.effect_size import MeansEffect, MeansSampleSize
