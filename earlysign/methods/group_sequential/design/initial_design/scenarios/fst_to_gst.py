...
Notes
-----
All imports are restricted to modules under ``earlysign.stats`` and
``earlysign.methods``. The implementations prefer existing building blocks:
...
from earlysign.methods.group_sequential.design.initial_design.helpers.protocols import (
    ProcedureFactory,
    ProcedureLike,
)
...
from earlysign.methods.group_sequential.design.initial_design.workflows.optimize_timing.minimize_asn import (
