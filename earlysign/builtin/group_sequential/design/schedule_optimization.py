...
EXAMPLES:
    ...
    >>> from earlysign.builtin.group_sequential.design.schedule_optimization import optimize_schedule
    ...
    >>> from earlysign.builtin.group_sequential.core.model import SimulationConfig
