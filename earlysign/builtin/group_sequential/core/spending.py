...
class SpendingFunctionFactory:
    ...
    Example::
        ...
        >>> from earlysign.builtin.group_sequential.schema.strategies import SpendingFunction
        >>> from earlysign.builtin.group_sequential.core.spending import SpendingFunctionFactory
