...
from earlysign.v0.methods.group_sequential import spending as spending_mod
...
class GroupSequentialBoundaryRecord(LedgerRecord, QueryMixin):
    ...
    Stores efficacy and futility boundaries resolved at a given information
    time, plus design metadata.
    """
