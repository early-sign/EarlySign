...
utilities in ``earlysign.v0.methods.group_sequential.report`` consume the results.
"""
...
from earlysign.v0.methods.group_sequential.report.plot_oc_curve import OCCurvePlotter
