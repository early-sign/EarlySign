...
from earlysign.v0.methods.group_sequential.canonical_joint_distribution import (
    CanonicalJointDistribution,
)
from earlysign.v0.methods.group_sequential.design.planner import DesignPlanner
from earlysign.v0.methods.group_sequential.evaluation.evaluator import (
...
def when_group_sequential_t_test_eval(design_params, planner, evaluator, cjd):
    ...
    from earlysign.v0.methods.group_sequential.boundary import nominal_t_from_z
