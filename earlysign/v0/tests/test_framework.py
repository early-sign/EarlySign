"""
Doctests for earlysign.v0.framework integration (current API).
...
>>> from earlysign.v0.methods.group_sequential.schemes.two_proportions.binomial_arms import BinomialArmSnapshot
>>> from earlysign.v0.methods.group_sequential.schemes.two_proportions.wald_z import (
...     BinomialWaldZ,
...     WaldZStatisticRecord,
... )
>>> from earlysign.v0.methods.group_sequential.decision import GSDecisionFromWaldZ
>>> from earlysign.v0.methods.group_sequential.boundary import GroupSequentialBoundaryRecord
>>> from earlysign.v0.methods.group_sequential.decision import GroupSequentialDecisionSignalRecord
>>> from earlysign.v0.methods.group_sequential.design.records.design import GroupSequentialDesignRecord
